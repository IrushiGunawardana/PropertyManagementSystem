        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PropertyTenants_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Jobs_ServiceProviders_ServiceProviderId",
            ...
            migrationBuilder.CreateTable(
                name: "ServiceProviderJobTypes",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    JobTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ServiceProviderUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceProviderJobTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceProviderJobTypes_JobTypes_JobTypeId",
                        column: x => x.JobTypeId,
                        principalTable: "JobTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceProviderJobTypes_ServiceProviders_ServiceProviderUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Jobs_ServiceProviderId",
                table: "Jobs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyTenants_UserId",
                table: "PropertyTenants",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceProviderJobTypes_JobTypeId",
                table: "ServiceProviderJobTypes",
                column: "JobTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceProviderJobTypes_ServiceProviderUserId",
                table: "ServiceProviderJobTypes",
